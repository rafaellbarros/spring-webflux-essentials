...
public class AnimeControllerIT {
    ...
    private final static String REGULAR_USER = "xablau";
    private final static String ADMIN_USER = "rafaellbarros";
    ...
    public void listAll_ReturnsUnauthorized_WhenUserIsNotAuthenticated() {
        client
                ...
                .uri("/animes")
                .exchange()
                .expectStatus().is5xxServerError(); // TODO: veify isUnauthorazied
    }
    ...
    public void listAll_ReturnForbidden_WhenUserDoesNotHaveRoleAdmin() {
        client
                ...
                //.expectStatus().isForbidden(); TODO: verffy
    }

 ...
 * created by:
 *
 * @author rafael for DevDusCorre on 03/01/2022
 */
...
class AnimeControllerTest {
    ...
    @Test
    @DisplayName("saveBatch creates a list of a nome when successful")
    public void save_BatchListOfAnime_WhenSuccessful() {
        Anime animeToBeSaved = AnimeCreator.createAnimeToBeSaved();
